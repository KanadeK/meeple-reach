...
- [ ] Initialize an isolated Git repository with package metadata and license.

Gate: the specification describes a real end-to-end result and distinct failures.

## Phase 2 — Core, test first

- [ ] Add failing model/audit/planner tests.
- [ ] Implement strict scenario validation and normalization.
- [ ] Implement deterministic audit metrics.
- [ ] Implement exact discrete search, collisions, objective, and node limit.
...
- [ ] Add failing CLI and artifact tests.
- [ ] Implement CLI and documented exit codes.
- [ ] Generate JSON, CSV, SVG, and self-contained HTML.
- [ ] Build a browser demo from the same core modules.

Gate: the sample runs from both an installed package and a real browser.

## Phase 4 — Delivery

- [ ] Add sample and invalid/impossible fixtures.
- [ ] Write English/Chinese usage, format, algorithm, test, security, and troubleshooting docs.
- [ ] Add cross-platform Node CI, Pages deployment, packaging, and release gates.
- [ ] Run review, simplification, full local acceptance, and package-install smoke test.
